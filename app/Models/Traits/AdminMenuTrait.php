...
trait AdminMenuTrait
{
    ...
    public function roles()
    {
        return $this->belongsToMany(
            ...
            Config::get('admin.menu_role_table'),
            Config::get('admin.menu_foreign_key'),
    ...
    public function perms()
    {
        return $this->belongsToMany(
            ...
            Config::get('admin.permission_menu_table'),
            Config::get('admin.menu_foreign_key'),
    ...
    public static function toTree(array $elements = [], $parentId = 0, $roleIds = [])
    {
        ...
        foreach ($elements as $element) {
            ...
            if ($element['parent_id'] == $parentId) {
                ...
                //传入 这些父级的 id 当作下一轮的 父亲id 得到他们的子集
