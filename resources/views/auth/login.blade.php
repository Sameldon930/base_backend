        ...
        <div class="m-login-warp">
            <form class="layui-form" method="post" action="{{url('/login')}}">
                ...
                <div class="layui-form-item">
                    <input type="text" value="{{ old('user_name') }}" name="user_name" required lay-verify="user_name" placeholder="用户名" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
